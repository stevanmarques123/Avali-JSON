async function bla() {
    const destino = document.getElementById('indo');
    try {
        ...
        paginas.forEach(item => {
            ...
            <td><button onclick="removerLinha(this)">Apagarxx</button></td>
...
function adicionarlinha(botao){
 ...
 input1.value = celulas[1].innerHTML;
 input1.value = celulas[2].innerHTML;
 input1.value = celulas[3].innerHTML;
